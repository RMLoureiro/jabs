...
public class Main {
        ...
        public static void main(String[] args) throws IOException {
                 ...
                 * 3600);
                 * scenario.AddNewLogger(new
                 * SnowCSVLogger(Paths.get("output/snow-simulation-log.csv")));
                 * scenario.run();
                 * 
                 */

                // Simulate Slush LAN network of 40 nodes for 1 hour
                scenario = new SnowLANScenario("One hour of a Slush lan Network", 1, 40,
                                3600);
